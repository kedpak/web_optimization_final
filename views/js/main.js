...
var resizePizzas = function(size) {
  ...
  // Changed changePizzaSizes function by including switch statement and removing dxdetermine
...
function updatePositions() {
  ...
  var body = document.body.scrollTop;  //placed document.body.scrollTop into variable to fix fps issue
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  requestAnmationFrame(updatePositions);
});
